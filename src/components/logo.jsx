...
const logo = () => {
  return (
    <Link to="https://chrome-extension-two.vercel.app/" target="_blank" rel="noopener noreferrer" className="logo w-[10rem] xl:ml-[3rem] inline-flex justify-center gap-1">
